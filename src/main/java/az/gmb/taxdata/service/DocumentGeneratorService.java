...
public class DocumentGeneratorService {
    ...
    private double standardRowHeight(double defaultHeight,int lines,double fontPt){
        ...
        double lineHeight=Math.max(15.5d,Math.ceil(Math.max(9d,fontPt)*1.35d*2d)/2d);
        double raw=normalizedLines*lineHeight+(normalizedLines==1?2d:4d);
    ...
    private int estimateLines(String text,double widthChars,double fontPt,boolean bold,boolean italic){
        ...
        double limitPx=Math.max(24d,widthChars*7d*0.84d-10d);
